...
- Clone the repo or download the [install_dragonchain_uvn.sh](https://raw.githubusercontent.com/Dragonchain-Community/dragonchain-uvn-installer/release-v1.1-dragon-3.5.0/install_dragonchain_uvn.sh) file
